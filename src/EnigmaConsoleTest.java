...
public class EnigmaConsoleTest {
    ...
    public static void main(String[] args) {
        ...
        // --- 7. Forward Pass (RTL) ---
        int inputIndex = charToIndex.get('B'); // B is the effective input (e.g., after Plugboard B|C)
        ...
        System.out.println("Reflector simulation");
        // Simulated Reflector Output (Assuming it reflects signal '4' to '1')
        System.out.println("Now sending: B (Index 1) from reflector");
